...
class CavesControllerTest < ActionController::TestCase
  ...
  test "should create cafe" do
    assert_difference('Cafe.count') do
      post :create, cafe: { description: @cafe.description, location_id: @cafe.location_id, name: @cafe.name }
    end
  ...
  test "should update cafe" do
    patch :update, id: @cafe, cafe: { description: @cafe.description, location_id: @cafe.location_id, name: @cafe.name }
    assert_redirected_to cafe_path(assigns(:cafe))
  end
